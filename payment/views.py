	...
	if request.method == 'POST':
		...
		if result.is_success:
			...
			client.send_message({
				'from': '18595920844',
				'to': '14027066443',
				'text': 'Thank you {} {}, Your order {} has been placed successfully and will be delivered to {}, {}, {}'.format(order.first_name,order.last_name,order.id,order.address,order.city,order.postal_code)
			})
